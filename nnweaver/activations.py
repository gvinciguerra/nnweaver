...
class Linear(Activation):
    def __call__(self, x):
        """ Compute the linear activation function (identity) on each
    ...
    def gradient(self, x):
        ...
        (constant to 1) on each element of the input array.
...
class Rectifier(Activation):
    def __call__(self, x):
        """ Compute the rectifier activation function on each element
        of the input array.
    ...
    def gradient(self, x):
        """ Compute the gradient of the rectifier activation function on
...
class Sigmoid(Activation):
    ...
    def gradient(self, x):
        """ Compute the gradient of the sigmoid activation function on
        each element of the input array.
