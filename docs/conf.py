...
# -*- coding: utf-8 -*-
#
# NNWeaver documentation build configuration file, created by
...
project = 'NNWeaver'
copyright = '2018, Landolfi Francesco, Vinciguerra Giorgio'
author = 'Landolfi Francesco, Vinciguerra Giorgio'
...
latex_documents = [
    (master_doc, 'NNWeaver.tex', 'NNWeaver Documentation',
